        ...
        <div class="card">
            <form class="floating-labels m-t-40" action="{{route('admin.user.store')}}" method="POST"
                ...
                <div class="card-body">
                    ...
                    <div class="form-group m-b-40">
                        <input type="text" name="nip" class="form-control" id="input1" required>
                        <span class="bar"></span>
                    ...
                    <div class="form-group m-b-40">
                        <input type="text" name="alamat" class="form-control" id="input1" required>
                        <span class="bar"></span>
                    ...
                    <div class="form-group m-b-40">
                        <input type="text" name="no_hp" class="form-control" id="input1" required>
                        <span class="bar"></span>
