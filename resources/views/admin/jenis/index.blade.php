    ...
    <div class="col-md-7 align-self-center text-right">
        <div class="d-flex justify-content-end align-items-center">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Data Jenis Sampel</li>
            </ol>
            <a href="{{Route('admin.jenis.create')}}" class="btn btn-info d-none d-lg-block m-l-15"><i
                    ...
                    <table id="myTable" class="table table-bordered table-striped dataTable no-footer text-center"
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$d->jenis}}</td>
                                <td>
                                    <a href="{{Route('admin.jenis.edit',$d->id)}}" class="btn btn-info m-l-15"><i
                                            class="fa fa-edit"></i>
                                        Edit</a>
                                    <button type="button" data-route="{{Route('admin.jenis.destroy',$d->id)}}"
