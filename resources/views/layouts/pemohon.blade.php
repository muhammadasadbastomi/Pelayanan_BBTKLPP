        ...
        <div class="scroll-sidebar">
            ...
            <nav class="sidebar-nav">
                <ul id="sidebarnav">
                    ...
                    <li> <a class="waves-effect waves-dark" href="{{Route('pemohon.index')}}"><i
                ...
                <li> <a class="waves-effect waves-dark" href="{{route('pemohon.permohonan.index')}}"><i
